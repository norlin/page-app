...
module.exports = function (options) {
	...
	App.prototype.readConfig = function () {
		...
		this.options.app = this.name;
		this.options.path = (this.options.prefix || '') + this.name;
	...
	App.prototype.createLandingPage = function (common) {
		...
		app.generated = {
			layout: {
				scripts: common.js.concat(app.base.files.js),
				scriptsIE: common.jsIE.concat(app.base.files.jsIE),
				scriptsTest: common.jsTest.concat(app.base.files.jsTest),
				scriptsTestCases: common.jsTestCases.concat(app.base.files.jsTestCases),
				styles: common.css.concat(app.base.files.css),
				stylesIE: common.cssIE.concat(app.base.files.cssIE),
